...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYNC_RTC_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBOX_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ISOAL_LOG_LEVEL, 4);
